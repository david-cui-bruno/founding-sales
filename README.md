...
| `src/renderer/` | React 19 UI: shell and route registry in `src/renderer/app/`; Today, Accounts and Campaigns in `src/renderer/features/today/` and `src/renderer/features/campaigns/`; Settings in `src/renderer/foundation/`. The legacy person routes were removed on 17 September 2026 and the LinkedIn manual-draft feature on 18 September 2026. |
