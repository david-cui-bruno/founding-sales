...
module "delegated_worker" {
  ...
  delegated_worker_legacy_research_enabled = var.delegated_worker_legacy_research_enabled
  delegated_worker_legacy_tick_enabled     = var.delegated_worker_legacy_tick_enabled
