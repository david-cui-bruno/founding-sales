...
See `docs/archive/decisions/g1-no-flow-logs.md`, section "CloudTrail", for the reasoning. This file exists because `docs/greenfield/infra-topology.md` cites it by name in its "what is deliberately not here" list.
