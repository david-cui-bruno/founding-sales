...
`docs/archive/decisions/g12f-the-rehearsals-own-guard-refused-the-rehearsal.md` and
...
instead (`docs/archive/decisions/g12-the-credentialed-bootstrap.md`), which needs no
