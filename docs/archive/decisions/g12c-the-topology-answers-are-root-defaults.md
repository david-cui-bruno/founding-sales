...
PR 134 recorded David's five answers (`docs/archive/decisions/coord-topology-answers.md`) and
...
| 5 · VPC flow logs | no flow-log resource exists anywhere in `infra/` (`docs/archive/decisions/g1-no-flow-logs.md`). Nothing to default. |
