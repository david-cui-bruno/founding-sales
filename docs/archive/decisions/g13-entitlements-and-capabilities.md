...
access control list (`docs/archive/decisions/g13-keychain-acl.md`), not by an entitlement.
...
`docs/archive/decisions/g13-local-smoke-mode.md` — and is refused for that reason.
...
(`docs/archive/decisions/g13-update-application.md`), and is the only folder outside its own
