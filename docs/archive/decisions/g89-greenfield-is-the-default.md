...
`docs/greenfield/`, `docs/archive/decisions/`, the `greenfield*.yml` workflows, the two
...
no old test reads `docs/greenfield/`, `docs/archive/decisions/`, `certs/` or the root README.
