...
`docs/decisions/g7b-ambiguity-stays-where-g7-put-it.md` says the window should use.
...
API gains is never uneditable. This supersedes `docs/decisions/g9-settings-editing-is-json.md`
...
leaves on (`docs/decisions/g60-calling-identities-are-attested-in-version-one.md`). So the
