...
function receiptOnly(value: VerifiedBackup): PreReleaseReceipt {
  ...
  if (typeof basename !== 'string' || !/^pre_release-[0-9]{8}T[0-9]{9}Z\.sqlite3$/.test(basename) || kind !== 'pre_release'
    || (schemaVersion !== 24 && schemaVersion !== 25 && schemaVersion !== 26 && schemaVersion !== 27 && schemaVersion !== 28 && schemaVersion !== 29 && schemaVersion !== 30) || typeof sha256 !== 'string' || !/^[a-f0-9]{64}$/.test(sha256) || !Number.isSafeInteger(sizeBytes) || sizeBytes <= 0
