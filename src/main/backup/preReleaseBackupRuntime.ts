...
import { assertDomainStorageReady, DOMAIN_SCHEMA_MANIFEST } from '../domain/startup/storageReadiness';
...
function receiptOnly(value: VerifiedBackup): PreReleaseReceipt {
  ...
  if (typeof basename !== 'string' || !/^pre_release-[0-9]{8}T[0-9]{9}Z\.sqlite3$/.test(basename) || kind !== 'pre_release'
    || schemaVersion !== 21 || typeof sha256 !== 'string' || !/^[a-f0-9]{64}$/.test(sha256) || !Number.isSafeInteger(sizeBytes) || sizeBytes <= 0
