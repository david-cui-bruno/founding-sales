...
const pendingWorkflowApis = (): Omit<CalliePreloadApi, 'health' | 'appleSpike'> => {
  ...
  return {
    daily: { get: pending() },
    localWorkspace: { get: pending(), getCompany: pending(), researchCompany: pending(), getCompanyResearchStatus: pending(), linkCompanyPerson: pending(), getCommitments: pending(), reviewCompany: pending(), createCompany: pending(), getCompanyCreateStatus: pending(), transition: pending() },
