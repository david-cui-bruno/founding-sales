...
it.each([
  ...
  render(<PresentationRoot><NativeDeskRoute firstUse={f.firstUse} api={f.api} surface={surface} /></PresentationRoot>);
...
it.each(['today', 'accounts', 'campaigns'] as const)('marks unresolved and first-failed %s as presentation only', async surface => {
  ...
  const view = render(<PresentationRoot><NativeDeskRoute firstUse={f.firstUse} api={f.api} surface={surface} /></PresentationRoot>);
