...
/**
 * Every `/v1` command, discriminated on `kind`. S0 ships `revoke_device`, S1 adds `set_state_posture`, S2 adds the call
 * and firm commands, S3 adds email, S4 adds research; later slices add theirs here.
 */
