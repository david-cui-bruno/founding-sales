/** Synchronous SHA-256 over UTF-8, for bounded cross-process display bindings.
 * FIPS 180-4 compression and padding. TextEncoder gives identical browser/Node
 * UTF-8 replacement semantics for unpaired surrogates. No Node or provider IO.
 */
