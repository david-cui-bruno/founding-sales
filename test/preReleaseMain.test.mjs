...
it('dispatches the reserved headless mode without normal lock, renderer protocol, startup, logging or windows', async () => {
  ...
  vi.doMock('../src/main/diagnostics/startupDiagnoseRuntime', () => ({ isStartupDiagnoseInvocation: () => false, runStartupDiagnoseHost: vi.fn(), StartupDiagnoseRefusedError: Error }));
