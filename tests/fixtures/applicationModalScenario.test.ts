...
function setup() {
  ...
  const api: Parameters<typeof installApplicationModalScenario>[0] = {
    ...
    delegation: {
      getAccountPreparation: deny('delegation.getAccountPreparation'),
      ...
      prepareRequestedFollowup: deny('delegation.prepareRequestedFollowup'), getRequestedFollowup: deny('delegation.getRequestedFollowup'), editRequestedFollowup: deny('delegation.editRequestedFollowup'), approveRequestedFollowup: deny('delegation.approveRequestedFollowup'), reconcileReplyDraft: deny('delegation.reconcileReplyDraft'), editReplyDraft: deny('delegation.editReplyDraft'), getPhoneHandoffState: deny('delegation.getPhoneHandoffState'), beginPhone: deny('delegation.beginPhone'), bootstrap: deny('delegation.bootstrap'), configurePolicy: deny('delegation.configurePolicy'), configureResearch: deny('delegation.configureResearch'), pair: deny('delegation.pair'), configure: deny('delegation.configure'), submit: deny('delegation.submit'), sync: deny('delegation.sync'),
    },
  };
