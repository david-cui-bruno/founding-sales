...
const scenarios = [
  ...
  'lifecycle-retention-immutability',
  ...
  'opt-out-rejects-open-workflow-or-pending-outbound',
  ...
  'source-intake-receipt-ownership',
  'source-intake-receipt-source-prospect',
  'deferred-source-intake-receipt',
  'immutable-activity',
  'immutable-stage',
  'immutable-trigger',
